...
START_TEST(test_rotate45){
  ...
  for(int i=0; i<6;i++){
    if(i==0){ck_assert(pixels[0]==to_test);}
    else{ck_assert(pixels[i]==0);}
  }
}END_TEST
...
START_TEST(test_rotate90){
  ...
  uint32_t *pixels     = (uint32_t *) g_cimp->screen->buff_screen->pixels;
  for(int i=0; i<6;i++){
    if(i==1){ck_assert(pixels[1]==to_test);}
    else{ck_assert(pixels[i]==0);}
  }
}END_TEST
START_TEST(test_rotate180){
  ...
  uint32_t *pixels     = (uint32_t *) g_cimp->screen->buff_screen->pixels;
  for(int i=0; i<6;i++){
    if(i==5){ck_assert(pixels[5]==to_test);}
    else{ck_assert(pixels[i]==0);}
  }
}END_TEST
START_TEST(test_rotateneg90){
  ...
  uint32_t *pixels     = (uint32_t *) g_cimp->screen->buff_screen->pixels;
  for(int i=0; i<6;i++){
    if(i==4){ck_assert(pixels[4]==to_test);}
    else{ck_assert(pixels[i]==0);}
  }
} END_TEST
...
START_TEST(test_sym_verti){
  ...
  uint32_t * pixels     = (uint32_t *) g_cimp->screen->buff_screen->pixels;
  for(int i=0; i<6;i++){
    if(i==2){ck_assert(pixels[2]==to_test);}
    else{ck_assert(pixels[i]==0);}
  }
}END_TEST
...
START_TEST(test_sym_hori){
  ...
  uint32_t * pixels     = (uint32_t *) g_cimp->screen->buff_screen->pixels;
  for(int i=0; i<6;i++){
    if(i==3){ck_assert(pixels[3]==to_test);}
    else{ck_assert(pixels[i]==0);}
  }
}END_TEST
